...
const ExperienceItem = ({ title, label = "", isActive = false, onClick }: ExperienceItem) => {
  return (
    <div className="w-auto">
      ...
      <button
        className={clsx(
          "capitalize w-full mx-1 text-sm md:text-base text-center lg:text-left border-b-1 pr-5 border-transparent hover:text-accent-foreground hover:border-accent-foreground",
